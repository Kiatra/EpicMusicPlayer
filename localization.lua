...
if L then
    L["New Sub Zone Event"] = true
    L["Create a new Sub zone event"] = true
    L["Print Zone Events"] = true
    L["EpicMusicPlayer: Playing song from list [%s] for sub-zone [%s]"] = true
    L["EpicMusicPlayer: Playing song from list [%s] for zone [%s]"] = true
