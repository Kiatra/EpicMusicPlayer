        ...
        general = {
            ...
            args = {
                ...
                controls = {
                    ...
                    args = {
                        text = {
                            ...
                            type = "description",
                            name = L
                                ["Set the click behaviour for the minimap, the title in the GUI and the data broker plugin."],
                        },
                        left = {
                            type = 'select',
                ...
                usePlaySoundFile = {
                    ...
                    desc = L
                        ["When this is enabled music will be played using the ambience channel instead of the music channel. Music will no longer stop on a loading screen but you will not hear ambience sound during music play."],
        ...
        list = {
            ...
            args = {
                ...
                loopsong = {
                    ...
                    name = L["Loop Song"],
                    desc = L
                        ["Play the current song again and again and again...until your head will explode. A click on next song will disable this."],
                    get = function()
                ...
                addGameMusic = {
                    ...
                    set = function()
                        EpicMusicPlayer.db.addGameMusic = not EpicMusicPlayer.db.addGameMusic
        ...
        events = {
            ...
            args = {
                ...
                newSubZone = {
                    type = 'input',
                    order = 0,
                    name = L["New Sub Zone Event"],
                    desc = L["Create a new Sub zone event"],
                    get = GetSubZoneText,
                    set = function(info, value)
                        local name = value
                        if not EpicMusicPlayer.db.eventZones.name then
                ...
                printZoneEvents = {
                    type = 'toggle',
                    order = 2,
                    name = L["Print Zone Events"],
                    desc = L["Print Zone Events"],
                    get = function()
                        return EpicMusicPlayer.db.printZoneEvents
                    end,
                    set = function()
                        db.printZoneEvents = not EpicMusicPlayer.db.printZoneEvents
                    end,
                },
            },
        },
        help = {
            ...
            args = {
                ...
                text4 = {
                    ...
                    type = "description",
                    name = L
                        ["Music played on the music channel will stop after a loading screen. Enable the option to use the ambient sound channel to avoid this."],
                },
                header5 = {
                    type = "header",
                ...
                text6 = {
                    ...
                    type = "description",
                    name = L
                        ["Playlists shipped with the addon or created by the PlaylistCreator are locked for editing."] ..
                        " " .. L["You can right click user created playlist and delete or export them."],
                }
            }
        }
    },
